...
<header id="site-header">
  <div class="container nav-inner">
    <a href="index.html" class="nav-logo"><img class="nav-logo-mark" src="assets/jf-mark-navy-wm.png" alt="Jet Force Grease &amp; Pipe Solutions"><span class="nav-logo-wm"><span class="nav-logo-name">JET FORCE</span><span class="nav-logo-mid">Underground</span><span class="nav-logo-sub">Pipe Contractor</span></span></a>
    <nav class="nav-links">
      <div class="nav-drop">
